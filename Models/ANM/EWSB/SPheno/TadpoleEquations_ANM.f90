...
Subroutine SolveTadpoleEquations(g1,g2,g3,LambdaVari4,Yu,Yd,Ye,m2SM,vvSM,Tad1Loop)
...
m2SM = -1._dp/2._dp*(vvSM**2*LambdaVari4) + Tad1Loop(1)/vvSM
...
Subroutine CalculateTadpoles(g1,g2,g3,LambdaVari4,Yu,Yd,Ye,m2SM,vvSM,Tad1Loop,        & 
& TadpoleValues)
...
TadpoleValues(1) = Real(m2SM*vvSM + (vvSM**3*LambdaVari4)/2._dp - Tad1Loop(1),dp) 
End Subroutine CalculateTadpoles 

End Module Tadpoles_ANM 
