...
Module Boundaries_ANM 
 
Use Control 
Use Settings 
Use LoopCouplings_ANM 
Use LoopMasses_ANM 
Use LoopFunctions 
Use Mathematics 
Use Model_Data_ANM 
...
& g1,g2,g3,LambdaVari4,Yu,Yd,Ye,m2SM,delta0,gMZ,kont)
...
Complex(dp) :: cplcUFeFeAhL(3,3),cplcUFeFeAhR(3,3),cplcUFeFehhL(3,3),cplcUFeFehhR(3,3),              & 
...
MFd = sqrt(MFd2) 
MFu = sqrt(MFu2) 
alphaQ = AlphaEw_T(alphaEW_MS,mudim,Abs(MHp),Abs(MVWp),Abs(MFe),Abs(MFu),Abs(MFd)) 
...
MFd = sqrt(MFd2) 
MFu = sqrt(MFu2) 
alpha3 = AlphaS_T(alphaS_MS,mudim,Abs(MFu),Abs(MFd)) 
...
delta_emmatch= DeltaAlphaEW_T(g1sm**2*g2sm**2*oo4pi/(g1sm**2+g2sm**2),mudim,Abs(MHp),Abs(MVWp),Abs(MFe),Abs(MFu),Abs(MFd)) 
...
Call SetMatchingConditions(g1SM,g2SM,g3SM,YuSM,YdSM,YeSM,vSM,vvSM,g1,g2,              & 
& g3,LambdaVari4,Yu,Yd,Ye,m2SM,.True.)
...
! Full one-loop corrections
Call CouplingsForSMfermions(Ye,ZEL,ZER,g1,g2,TW,Yu,ZUL,ZUR,Yd,ZDL,ZDR,g3,             & 
...
& cplcUFuFuAhL,cplcUFuFuAhR,cplcUFuFdHpL,cplcUFuFdHpR,cplcUFuFdVWpL,cplcUFuFdVWpR,       & 
& cplcUFuFuhhL,cplcUFuFuhhR,cplcUFuFuVGL,cplcUFuFuVGR,cplcUFuFuVPL,cplcUFuFuVPR,         & 
& cplcUFuFuVZL,cplcUFuFuVZR,cplcUFdFdAhL,cplcUFdFdAhR,cplcUFdFdhhL,cplcUFdFdhhR,         & 
& cplcUFdFdVGL,cplcUFdFdVGR,cplcUFdFdVPL,cplcUFdFdVPR,cplcUFdFdVZL,cplcUFdFdVZR,         & 
& cplcUFdFucHpL,cplcUFdFucHpR,cplcUFdFucVWpL,cplcUFdFucVWpR)
...
Call ParametersToG60(g1,g2,g3,LambdaVari4,Yu,Yd,Ye,m2SM,gMZ)
...
& g3,LambdaVari4,Yu,Yd,Ye,m2SM,mGut,kont,WriteComment,niter)
...
Real(dp) :: g_SM(62) 
Real(dp) :: delta0,deltaG0, gA(60), gB(60)
Real(dp) :: gC(61),  gD(61) 
Real(dp),Intent(out) :: mGUT
Complex(dp) :: Tad1Loop(1), lambda_SM, lambda_MZ 
Real(dp) :: comp(1), tanbQ, vev2 
Complex(dp) :: cplcUFeFehhL(3,3),cplcUFeFehhR(3,3),cplcUFuFuhhL(3,3),cplcUFuFuhhR(3,3),              & 
...
& LambdaVari4,Yu,Yd,Ye,m2SM,delta0,gB,kont)
...
mGUT = 1._dp 
Call GToParameters60(gB,g1,g2,g3,LambdaVari4,Yu,Yd,Ye,m2SM)
...
Real(dp):: gA(60), gB(60), Scale_Save 
