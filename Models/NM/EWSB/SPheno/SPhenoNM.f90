...
& Spar,Upar,ae,amu,atau,EDMe,EDMmu,EDMtau,dRho)
...
Real(dp),Intent(in) :: g1input,g2input,g3input,Laminput
...
Call ParametersToG61(g1,g2,g3,Lam,Yu,Yd,Ye,m2SM,vvSM,gD)
...
End if 
Call GToParameters61(gD,g1,g2,g3,Lam,Yu,Yd,Ye,m2SM,vvSM)
