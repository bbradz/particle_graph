...
Subroutine GToParameters60(g,g1,g2,g3,Lam,Yu,Yd,Ye,m2SM)
...
Subroutine ParametersToG60(g1,g2,g3,Lam,Yu,Yd,Ye,m2SM,g)

Implicit None 
Real(dp), Intent(out) :: g(60) 
Real(dp), Intent(in) :: g1,g2,g3,Lam
...
& Dg3,Lam,betaLam1,betaLam2,DLam
...
Call GToParameters60(gy,g1,g2,g3,Lam,Yu,Yd,Ye,m2SM)
...
Call ParametersToG60(Dg1,Dg2,Dg3,DLam,DYu,DYd,DYe,Dm2SM,f)

Iname = Iname - 1 
 
End Subroutine rge60  

Subroutine GToParameters61(g,g1,g2,g3,Lam,Yu,Yd,Ye,m2SM,vvSM)

Implicit None 
Real(dp), Intent(in) :: g(61) 
Real(dp),Intent(out) :: g1,g2,g3,Lam,vvSM
...
Subroutine ParametersToG61(g1,g2,g3,Lam,Yu,Yd,Ye,m2SM,vvSM,g)

Implicit None 
Real(dp), Intent(out) :: g(61) 
Real(dp), Intent(in) :: g1,g2,g3,Lam,vvSM
...
Real(dp) :: q 
Real(dp) :: g1,betag11,betag12,Dg1,g2,betag21,betag22,Dg2,g3,betag31,betag32,         & 
& Dg3,Lam,betaLam1,betaLam2,DLam,vvSM,betavvSM1,betavvSM2,DvvSM
Complex(dp) :: Yu(3,3),betaYu1(3,3),betaYu2(3,3),DYu(3,3),adjYu(3,3),Yd(3,3)          & 
& ,betaYd1(3,3),betaYd2(3,3),DYd(3,3),adjYd(3,3),Ye(3,3),betaYe1(3,3),betaYe2(3,3)       & 
& ,DYe(3,3),adjYe(3,3),m2SM,betam2SM1,betam2SM2,Dm2SM
Iname = Iname +1 
...
Call GToParameters61(gy,g1,g2,g3,Lam,Yu,Yd,Ye,m2SM,vvSM)
...
Call ParametersToG61(Dg1,Dg2,Dg3,DLam,DYu,DYd,DYe,Dm2SM,DvvSM,f)
