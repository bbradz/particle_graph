...
& LambdaVari4,Yu,Yd,Ye,mu2,GenerationMixing,kont)
...
Iname = Iname + 1 
NameOfUnit(Iname) = 'TreeMassesTNMA'
...
MHp2 = (4._dp*(mu2) + 2*vvSM**2*LambdaVari4 + g2**2*vvSM**2*RXiWp)/4._dp 
...
! ------------------------------- 
MAh2 = (2*(2._dp*(mu2) + vvSM**2*LambdaVari4) + vvSM**2*RXiZ*(g2*Cos(TW)              & 
&  + g1*Sin(TW))**2)/4._dp 
...
! ------------------------------- 
Mhh2 = mu2 + (3*vvSM**2*LambdaVari4)/2._dp 
...
& vvSM,g1,g2,g3,LambdaVari4,Yu,Yd,Ye,mu2,kont)
...
& g3,LambdaVari4,Yu,Yd,Ye,mu2,GenerationMixing,kont)
...
& TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,ZW,ZZ,vvSM,g1,g2,g3,LambdaVari4,Yu,Yd,Ye,mu2,               & 
...
End Module TreeLevelMasses_TNMA 
