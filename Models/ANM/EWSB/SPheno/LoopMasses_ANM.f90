...
& LambdaVari4,Yu,Yd,Ye,m2SM,kont)
...
Call CouplingsForLoopMasses(Ye,ZEL,ZER,g1,g2,TW,Yu,ZUL,ZUR,Yd,ZDL,ZDR,g3,             & 
& vvSM,LambdaVari4,cplcUFeFeAhL,cplcUFeFeAhR,cplcUFeFehhL,cplcUFeFehhR,cplcUFeFeVPL,     & 
...
m2SMTree  = m2SM
Call SolveTadpoleEquations(g1,g2,g3,LambdaVari4,Yu,Yd,Ye,m2SM,vvSM,Tad1Loop)

m2SM1L = m2SM
Call OneLoopHp(g2,m2SM1L,LambdaVari4,vvSM,MVWp,MVWp2,MAh,MAh2,MFd,MFd2,               & 
& MFu,MFu2,MFe,MFe2,MHp,MHp2,Mhh,Mhh2,MVZ,MVZ2,cplAhcHpVWp,cplcFdFucHpL,cplcFdFucHpR,    & 
...
Call OneLoopAh(g1,g2,m2SM1L,LambdaVari4,vvSM,TW,Mhh,Mhh2,MAh,MAh2,MFd,MFd2,           & 
...
Call OneLoophh(m2SM1L,LambdaVari4,vvSM,MAh,MAh2,MVZ,MVZ2,MFd,MFd2,MFe,MFe2,           & 
...
Subroutine OneLoopHp(g2,m2SM,LambdaVari4,vvSM,MVWp,MVWp2,MAh,MAh2,MFd,MFd2,           & 
& MFu,MFu2,MFe,MFe2,MHp,MHp2,Mhh,Mhh2,MVZ,MVZ2,cplAhcHpVWp,cplcFdFucHpL,cplcFdFucHpR,    & 
& cplcFeFvcHpL,cplcFeFvcHpR,cplcgZgWpcHp,cplcgWpgZHp,cplcgWCgZcHp,cplcgZgWCHp,           & 
& cplhhHpcHp,cplhhcHpVWp,cplHpcHpVP,cplHpcHpVZ,cplcHpVPVWp,cplcHpVWpVZ,cplAhAhHpcHp,     & 
...
Real(dp), Intent(in) :: g2,LambdaVari4,vvSM

Complex(dp), Intent(in) :: m2SM
...
mi2 = 0._dp 
mi2 = mi2+m2SM
mi2 = mi2+(vvSM**2*LambdaVari4)/2._dp
...
Subroutine OneLoopAh(g1,g2,m2SM,LambdaVari4,vvSM,TW,Mhh,Mhh2,MAh,MAh2,MFd,            & 
& MFd2,MFe,MFe2,MFu,MFu2,MVZ,MVZ2,MVWp,MVWp2,MHp,MHp2,cplAhAhhh,cplcFdFdAhL,             & 
...
& cplAhAhcVWpVWp,cplAhAhVZVZ,delta,mass,mass2,kont)

Real(dp), Intent(in) :: Mhh,Mhh2,MAh,MAh2,MFd(3),MFd2(3),MFe(3),MFe2(3),MFu(3),MFu2(3),MVZ,MVZ2,              & 
& MVWp,MVWp2,MHp,MHp2

Real(dp), Intent(in) :: g1,g2,LambdaVari4,vvSM,TW
...
Subroutine OneLoophh(m2SM,LambdaVari4,vvSM,MAh,MAh2,MVZ,MVZ2,MFd,MFd2,MFe,            & 
& MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,cplAhAhhh,cplAhhhVZ,cplcFdFdhhL,            & 
& cplcFdFdhhR,cplcFeFehhL,cplcFeFehhR,cplcFuFuhhL,cplcFuFuhhR,cplcgWpgWphh,              & 
& cplcgWCgWChh,cplcgZgZhh,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhcVWpVWp,cplhhVZVZ,       & 
& cplAhAhhhhh,cplhhhhhhhh,cplhhhhHpcHp,cplhhhhcVWpVWp,cplhhhhVZVZ,delta,mass,            & 
& mass2,kont)
...
mi2 = 0._dp 
mi2 = mi2+m2SM
mi2 = mi2+(3*vvSM**2*LambdaVari4)/2._dp
