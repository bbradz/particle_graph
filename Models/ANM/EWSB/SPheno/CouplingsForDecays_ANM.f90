...
& LambdaVari4input,Yuinput,Ydinput,Yeinput,m2SMinput,vvSMinput,cplHiggsPP,               & 
...
& MHp2input,MVWpinput,MVWp2input,MVZinput,MVZ2input,TWinput,ZDRinput,ZERinput,           & 
& ZURinput,ZDLinput,ZELinput,ZULinput,ZWinput,ZZinput,g1input,g2input,g3input,           & 
& LambdaVari4input,Yuinput,Ydinput,Yeinput,m2SMinput,vvSMinput,cplcFvFeVWpL,             & 
...
& MHp2input,MVWpinput,MVWp2input,MVZinput,MVZ2input,TWinput,ZDRinput,ZERinput,           & 
& ZURinput,ZDLinput,ZELinput,ZULinput,ZWinput,ZZinput,g1input,g2input,g3input,           & 
& LambdaVari4input,Yuinput,Ydinput,Yeinput,m2SMinput,vvSMinput,cplcFeFehhL,              & 
...
& MHp2input,MVWpinput,MVWp2input,MVZinput,MVZ2input,TWinput,ZDRinput,ZERinput,           & 
& ZURinput,ZDLinput,ZELinput,ZULinput,ZWinput,ZZinput,g1input,g2input,g3input,           & 
& LambdaVari4input,Yuinput,Ydinput,Yeinput,m2SMinput,vvSMinput,cplcFuFdVWpL,             & 
...
& MHp2input,MVWpinput,MVWp2input,MVZinput,MVZ2input,TWinput,ZDRinput,ZERinput,           & 
& ZURinput,ZDLinput,ZELinput,ZULinput,ZWinput,ZZinput,g1input,g2input,g3input,           & 
& LambdaVari4input,Yuinput,Ydinput,Yeinput,m2SMinput,vvSMinput,cplcFdFdhhL,              & 
...
End Module CouplingsForDecays_ANM
