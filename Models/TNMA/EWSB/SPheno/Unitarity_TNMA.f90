...
Subroutine ScatteringEigenvalues(vvSMinput,g1input,g2input,g3input,LambdaVari4input,  & 
& Yuinput,Ydinput,Yeinput,mu2input,delta0,kont)
...
Real(dp),Intent(in) :: g1input,g2input,g3input,LambdaVari4input,vvSMinput

Complex(dp),Intent(in) :: Yuinput(3,3),Ydinput(3,3),Yeinput(3,3),mu2input
...
scatter_matrix(1,8) =-1._dp*(LambdaVari4)
scatter_matrix(2,9) =-1._dp*(LambdaVari4)
scatter_matrix(3,3) =-2._dp*(LambdaVari4)
scatter_matrix(3,7) =-1._dp*(LambdaVari4)
scatter_matrix(4,6) =-1._dp*(LambdaVari4)
scatter_matrix(5,10) =-1._dp*(LambdaVari4)
scatter_matrix(6,4) =-1._dp*(LambdaVari4)
scatter_matrix(7,3) =-1._dp*(LambdaVari4)
scatter_matrix(7,7) =-2._dp*(LambdaVari4)
scatter_matrix(8,1) =-1._dp*(LambdaVari4)
scatter_matrix(9,2) =-1._dp*(LambdaVari4)
scatter_matrix(10,5) =-1._dp*(LambdaVari4)
...
& g3input,LambdaVari4input,Yuinput,Ydinput,Yeinput,mu2input,delta0,kont)
...
& Yu,Yd,Ye,mu2,.True.,kont)

Call CouplingsColourStructures(LambdaVari4,vvSM,cplAhAhhh,cplhhhhhh,cplhhHpcHp,       & 
