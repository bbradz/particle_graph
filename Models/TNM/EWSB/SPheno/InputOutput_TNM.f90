...
l_open= .False.
End If
Write(io_L,100) "# SUSY Les Houches Accord 2 - TNM Spectrum + Decays + Flavour Observables"
...
Write(io_L,1101) rHB_S_S_Fu(1,3),rHB_S_P_Fu(1,3), 3 ,25,9920995,9920995, " # h_1 t t coupling  " 
...
Subroutine WriteWHIZARD 
   Open(123,file="WHIZARD.par.TNM",status="unknown")
