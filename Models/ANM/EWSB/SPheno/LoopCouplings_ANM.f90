...
Real(dp) Function AlphaEwDR(Q,MHp,MVWp,MFe,MFu,MFd) 
 
Real(dp),Intent(in)::Q,MHp,MVWp,MFe(3),MFu(3),MFd(3)
Integer::i1 
Real(dp)::DeltaAlpha 
If (MZ_input) then 
...
Real(dp) Function AlphaSDR(Q,MFu,MFd) 
Real(dp),Intent(in)::Q,MFu(3),MFd(3) 
Integer::i1 
Real(dp)::DeltaAlpha 
DeltaAlpha = 0._dp 
...
Real(dp) Function AlphaEW_T(AlphaEW_In, Q,MHp,MVWp,MFe,MFu,MFd) 
 
Real(dp),Intent(in)::AlphaEW_In, Q,MHp,MVWp,MFe(3),MFu(3),MFd(3)
Integer::i1 
Real(dp)::DeltaAlpha 
...
Real(dp) Function DeltaAlphaEW_T(AlphaEW_In, Q,MHp,MVWp,MFe,MFu,MFd) 
...
Real(dp) Function AlphaS_T(AlphaS_In, Q,MFu,MFd) 
Real(dp),Intent(in):: AlphaS_In, Q,MFu(3),MFd(3) 
Integer::i1 
Real(dp)::DeltaAlpha 
DeltaAlpha=0._dp 
