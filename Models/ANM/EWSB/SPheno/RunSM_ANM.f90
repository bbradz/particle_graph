...
& Yuinput,Ydinput,Yeinput,m2SMinput,vvSMinput,g1,g2,g3,LambdaVari4,Yu,Yd,Ye,             & 
& m2SM,vvSM,CKMout,sinW2_out,Alpha_out,AlphaS_out,realCKM)
...
& Yeinput,m2SMinput,vvSMinput,g1D)

Call GToParameters61(g1D,g1,g2,g3,LambdaVari4,Yu,Yd,Ye,m2SM,vvSM)
