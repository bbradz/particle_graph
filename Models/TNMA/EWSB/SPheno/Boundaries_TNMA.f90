...
& g1,g2,g3,LambdaVari4,Yu,Yd,Ye,mu2,delta0,gMZ,kont)
...
Call SetMatchingConditions(g1SM,g2SM,g3SM,YuSM,YdSM,YeSM,vSM,vvSM,g1,g2,              & 
& g3,LambdaVari4,Yu,Yd,Ye,mu2,.True.)
...
Call ParametersToG60(g1,g2,g3,LambdaVari4,Yu,Yd,Ye,mu2,gMZ)
...
& g3,LambdaVari4,Yu,Yd,Ye,mu2,mGut,kont,WriteComment,niter)
...
& LambdaVari4,Yu,Yd,Ye,mu2,delta0,gB,kont)
...
mGUT = 1._dp 
Call GToParameters60(gB,g1,g2,g3,LambdaVari4,Yu,Yd,Ye,mu2)
...
Complex(dp),Intent(out) :: Yu(3,3),Yd(3,3),Ye(3,3),mu2
