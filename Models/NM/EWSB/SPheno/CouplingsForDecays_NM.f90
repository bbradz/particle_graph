...
Real(dp),Intent(in) :: g1input,g2input,g3input,Laminput,vvSMinput
...
& MHp2input,MVWpinput,MVWp2input,MVZinput,MVZ2input,TWinput,ZDRinput,ZERinput,           & 
& ZURinput,ZDLinput,ZELinput,ZULinput,ZWinput,ZZinput,g1input,g2input,g3input,           & 
& Laminput,Yuinput,Ydinput,Yeinput,m2SMinput,vvSMinput,cplcFvFeVWpL,cplcFvFeVWpR,        & 
...
End Module CouplingsForDecays_NM
