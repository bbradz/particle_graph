...
Real(dp) :: g1IN,g2IN,g3IN,LambdaVari4IN

Complex(dp) :: YuIN(3,3),YdIN(3,3),YeIN(3,3),mu2IN

Real(dp) :: g1MZ,g2MZ,g3MZ,LambdaVari4MZ

Complex(dp) :: YuMZ(3,3),YdMZ(3,3),YeMZ(3,3),mu2MZ

Real(dp) :: g1GUT,g2GUT,g3GUT,LambdaVari4GUT

Complex(dp) :: YuGUT(3,3),YdGUT(3,3),YeGUT(3,3),mu2GUT
...
Logical, save :: InputValueforLambdaVari4 =.False. 
