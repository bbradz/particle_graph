...
Module CouplingsForDecays_TNMA
...
& LambdaVari4input,Yuinput,Ydinput,Yeinput,mu2input,vvSMinput,cplHiggsPP,cplHiggsGG,     & 
...
& MHp2input,MVWpinput,MVWp2input,MVZinput,MVZ2input,TWinput,ZDRinput,ZERinput,           & 
& ZURinput,ZDLinput,ZELinput,ZULinput,ZWinput,ZZinput,g1input,g2input,g3input,           & 
& LambdaVari4input,Yuinput,Ydinput,Yeinput,mu2input,vvSMinput,cplcFvFeVWpL,              & 
...
& MHp2input,MVWpinput,MVWp2input,MVZinput,MVZ2input,TWinput,ZDRinput,ZERinput,           & 
& ZURinput,ZDLinput,ZELinput,ZULinput,ZWinput,ZZinput,g1input,g2input,g3input,           & 
& LambdaVari4input,Yuinput,Ydinput,Yeinput,mu2input,vvSMinput,cplcFeFehhL,               & 
...
& MHp2input,MVWpinput,MVWp2input,MVZinput,MVZ2input,TWinput,ZDRinput,ZERinput,           & 
& ZURinput,ZDLinput,ZELinput,ZULinput,ZWinput,ZZinput,g1input,g2input,g3input,           & 
& LambdaVari4input,Yuinput,Ydinput,Yeinput,mu2input,vvSMinput,cplcFuFdVWpL,              & 
...
& MHp2input,MVWpinput,MVWp2input,MVZinput,MVZ2input,TWinput,ZDRinput,ZERinput,           & 
& ZURinput,ZDLinput,ZELinput,ZULinput,ZWinput,ZZinput,g1input,g2input,g3input,           & 
& LambdaVari4input,Yuinput,Ydinput,Yeinput,mu2input,vvSMinput,cplcFdFdhhL,               & 
...
End Module CouplingsForDecays_TNMA
