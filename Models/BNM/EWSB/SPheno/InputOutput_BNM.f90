...
l_open= .False.
End If
Write(io_L,100) "# SUSY Les Houches Accord 2 - BNM Spectrum + Decays + Flavour Observables"
...
Subroutine WriteWHIZARD 
   Open(123,file="WHIZARD.par.BNM",status="unknown")
