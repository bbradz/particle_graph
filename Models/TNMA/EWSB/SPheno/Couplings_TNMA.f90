...
! ------------------------------------------------------------------------------  
! File created at 13:49 on 27.8.2025   
! ----------------------------------------------------------------------  
 
 
Module Couplings_TNMA
...
Contains 
 ...
 Subroutine AllCouplingsReallyAll(LambdaVari4,vvSM,g1,g2,TW,g3,Yd,ZDL,ZDR,             & 
& Ye,ZEL,ZER,Yu,ZUL,ZUR,cplAhAhhh,cplhhhhhh,cplhhHpcHp,cplAhAhAhAh,cplAhAhhhhh,          & 
...
Implicit None 
Real(dp), Intent(in) :: LambdaVari4,vvSM,g1,g2,TW,g3

Complex(dp), Intent(in) :: Yd(3,3),ZDL(3,3),ZDR(3,3),Ye(3,3),ZEL(3,3),ZER(3,3),Yu(3,3),ZUL(3,3),ZUR(3,3)
...
cplAhAhhh = 0._dp 
Call CouplingAhAhhhT(LambdaVari4,vvSM,cplAhAhhh)



cplhhhhhh = 0._dp 
Call CouplinghhhhhhT(LambdaVari4,vvSM,cplhhhhhh)



cplhhHpcHp = 0._dp 
Call CouplinghhHpcHpT(LambdaVari4,vvSM,cplhhHpcHp)



cplAhAhAhAh = 0._dp 
Call CouplingAhAhAhAhT(LambdaVari4,cplAhAhAhAh)



cplAhAhhhhh = 0._dp 
Call CouplingAhAhhhhhT(LambdaVari4,cplAhAhhhhh)



cplAhAhHpcHp = 0._dp 
Call CouplingAhAhHpcHpT(LambdaVari4,cplAhAhHpcHp)



cplhhhhhhhh = 0._dp 
Call CouplinghhhhhhhhT(LambdaVari4,cplhhhhhhhh)



cplhhhhHpcHp = 0._dp 
Call CouplinghhhhHpcHpT(LambdaVari4,cplhhhhHpcHp)



cplHpHpcHpcHp = 0._dp 
Call CouplingHpHpcHpcHpT(LambdaVari4,cplHpHpcHpcHp)
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
Call CouplingcFuFdHpT(gt1,gt2,Yu,Yd,ZUL,ZUR,ZDL,ZDR,cplcFuFdHpL(gt1,gt2)              & 
& ,cplcFuFdHpR(gt1,gt2))
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
Call CouplingcFdFucHpT(gt1,gt2,Yu,Yd,ZUL,ZUR,ZDL,ZDR,cplcFdFucHpL(gt1,gt2)            & 
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
Call CouplingcFuFdVWpT(gt1,gt2,g2,ZUL,ZDL,cplcFuFdVWpL(gt1,gt2),cplcFuFdVWpR(gt1,gt2))
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
Call CouplingcFdFucVWpT(gt1,gt2,g2,ZUL,ZDL,cplcFdFucVWpL(gt1,gt2),cplcFdFucVWpR(gt1,gt2))
...
Subroutine AllCouplings(LambdaVari4,vvSM,g1,g2,TW,g3,Yd,ZDL,ZDR,Ye,ZEL,               & 
...
Subroutine CouplingAhAhhhT(LambdaVari4,vvSM,res)

Implicit None 

Real(dp), Intent(in) :: LambdaVari4,vvSM
...
Subroutine CouplinghhhhhhT(LambdaVari4,vvSM,res)
...
Subroutine CouplinghhHpcHpT(LambdaVari4,vvSM,res)
...
Subroutine CouplingAhAhAhAhT(LambdaVari4,res)

Implicit None 

Real(dp), Intent(in) :: LambdaVari4
...
Subroutine CouplingAhAhhhhhT(LambdaVari4,res)
...
Subroutine CouplingAhAhHpcHpT(LambdaVari4,res)
...
Subroutine CouplinghhhhhhhhT(LambdaVari4,res)
...
Subroutine CouplinghhhhHpcHpT(LambdaVari4,res)
...
Subroutine CouplingHpHpcHpcHpT(LambdaVari4,res)
...
Subroutine CouplingcFuFdHpT(gt1,gt2,Yu,Yd,ZUL,ZUR,ZDL,ZDR,resL,resR)

Implicit None 

Integer, Intent(in) :: gt1,gt2
Complex(dp), Intent(in) :: Yu(3,3),Yd(3,3),ZUL(3,3),ZUR(3,3),ZDL(3,3),ZDR(3,3)
...
Subroutine CouplingcFdFucHpT(gt1,gt2,Yu,Yd,ZUL,ZUR,ZDL,ZDR,resL,resR)
...
Subroutine CouplingcFuFdVWpT(gt1,gt2,g2,ZUL,ZDL,resL,resR)
...
Complex(dp), Intent(in) :: ZUL(3,3),ZDL(3,3)
...
Subroutine CouplingcFdFucVWpT(gt1,gt2,g2,ZUL,ZDL,resL,resR)
...
Subroutine CouplingsForEffPot4(LambdaVari4,cplAhAhAhAh,cplAhAhhhhh,cplAhAhHpcHp,      & 
...
cplAhAhAhAh = 0._dp 
Call CouplingAhAhAhAh2L(LambdaVari4,cplAhAhAhAh)



cplAhAhhhhh = 0._dp 
Call CouplingAhAhhhhh2L(LambdaVari4,cplAhAhhhhh)



cplAhAhHpcHp = 0._dp 
Call CouplingAhAhHpcHp2L(LambdaVari4,cplAhAhHpcHp)



cplhhhhhhhh = 0._dp 
Call Couplinghhhhhhhh2L(LambdaVari4,cplhhhhhhhh)



cplhhhhHpcHp = 0._dp 
Call CouplinghhhhHpcHp2L(LambdaVari4,cplhhhhHpcHp)



cplHpHpcHpcHp = 0._dp 
Call CouplingHpHpcHpcHp2L(LambdaVari4,cplHpHpcHpcHp)
...
Subroutine CouplingsForEffPot3(LambdaVari4,vvSM,g3,Yd,ZDL,ZDR,Ye,ZEL,ZER,             & 
& Yu,ZUL,ZUR,cplAhAhhh,cplhhhhhh,cplhhHpcHp,cplVGVGVG,cplcFdFdAhL,cplcFdFdAhR,           & 
...
Implicit None 
Real(dp), Intent(in) :: LambdaVari4,vvSM,g3
...
cplAhAhhh = 0._dp 
Call CouplingAhAhhh2L(LambdaVari4,vvSM,cplAhAhhh)



cplhhhhhh = 0._dp 
Call Couplinghhhhhh2L(LambdaVari4,vvSM,cplhhhhhh)



cplhhHpcHp = 0._dp 
Call CouplinghhHpcHp2L(LambdaVari4,vvSM,cplhhHpcHp)
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
Call CouplingcFuFdHp2L(gt1,gt2,Yu,Yd,ZUL,ZUR,ZDL,ZDR,cplcFuFdHpL(gt1,gt2)             & 
& ,cplcFuFdHpR(gt1,gt2))
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
Call CouplingcFdFucHp2L(gt1,gt2,Yu,Yd,ZUL,ZUR,ZDL,ZDR,cplcFdFucHpL(gt1,gt2)           & 
& ,cplcFdFucHpR(gt1,gt2))
...
Subroutine CouplingAhAhAhAh2L(LambdaVari4,res)
...
Subroutine CouplingAhAhhhhh2L(LambdaVari4,res)
...
Subroutine CouplingAhAhHpcHp2L(LambdaVari4,res)
...
Subroutine Couplinghhhhhhhh2L(LambdaVari4,res)
...
Subroutine CouplinghhhhHpcHp2L(LambdaVari4,res)
...
Subroutine CouplingHpHpcHpcHp2L(LambdaVari4,res)
...
Subroutine CouplingAhAhhh2L(LambdaVari4,vvSM,res)
...
Subroutine Couplinghhhhhh2L(LambdaVari4,vvSM,res)
...
Subroutine CouplinghhHpcHp2L(LambdaVari4,vvSM,res)
...
Subroutine CouplingcFuFdHp2L(gt1,gt2,Yu,Yd,ZUL,ZUR,ZDL,ZDR,resL,resR)
...
Subroutine CouplingcFdFucHp2L(gt1,gt2,Yu,Yd,ZUL,ZUR,ZDL,ZDR,resL,resR)
...
Subroutine CouplingsForLoopMasses(Ye,ZEL,ZER,g1,g2,TW,Yu,ZUL,ZUR,Yd,ZDL,              & 
& ZDR,g3,vvSM,LambdaVari4,cplcUFeFeAhL,cplcUFeFeAhR,cplcUFeFehhL,cplcUFeFehhR,           & 
& cplcUFeFeVPL,cplcUFeFeVPR,cplcUFeFeVZL,cplcUFeFeVZR,cplcUFeFvcHpL,cplcUFeFvcHpR,       & 
& cplcUFeFvcVWpL,cplcUFeFvcVWpR,cplcUFuFuAhL,cplcUFuFuAhR,cplcUFuFdHpL,cplcUFuFdHpR,     & 
& cplcUFuFdVWpL,cplcUFuFdVWpR,cplcUFuFuhhL,cplcUFuFuhhR,cplcUFuFuVGL,cplcUFuFuVGR,       & 
& cplcUFuFuVPL,cplcUFuFuVPR,cplcUFuFuVZL,cplcUFuFuVZR,cplcUFdFdAhL,cplcUFdFdAhR,         & 
& cplcUFdFdhhL,cplcUFdFdhhR,cplcUFdFdVGL,cplcUFdFdVGR,cplcUFdFdVPL,cplcUFdFdVPR,         & 
& cplcUFdFdVZL,cplcUFdFdVZR,cplcUFdFucHpL,cplcUFdFucHpR,cplcUFdFucVWpL,cplcUFdFucVWpR,   & 
...
Implicit None 
Real(dp), Intent(in) :: g1,g2,TW,g3,vvSM,LambdaVari4

Complex(dp), Intent(in) :: Ye(3,3),ZEL(3,3),ZER(3,3),Yu(3,3),ZUL(3,3),ZUR(3,3),Yd(3,3),ZDL(3,3),ZDR(3,3)

Complex(dp), Intent(out) :: cplcUFeFeAhL(3,3),cplcUFeFeAhR(3,3),cplcUFeFehhL(3,3),cplcUFeFehhR(3,3),              & 
...
& cplcUFuFuVZL(3,3),cplcUFuFuVZR(3,3),cplcUFdFdAhL(3,3),cplcUFdFdAhR(3,3),               & 
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
Call CouplingcFdFucHpL(gt1,gt2,Yu,Yd,ZUL,ZUR,ZDL,ZDR,cplcFdFucHpL(gt1,gt2)            & 
& ,cplcFdFucHpR(gt1,gt2))
...
cplhhHpcHp = 0._dp 
Call CouplinghhHpcHpL(LambdaVari4,vvSM,cplhhHpcHp)
...
cplAhAhHpcHp = 0._dp 
Call CouplingAhAhHpcHpL(LambdaVari4,cplAhAhHpcHp)



cplhhhhHpcHp = 0._dp 
Call CouplinghhhhHpcHpL(LambdaVari4,cplhhhhHpcHp)



cplHpHpcHpcHp = 0._dp 
Call CouplingHpHpcHpcHpL(LambdaVari4,cplHpHpcHpcHp)
...
cplAhAhhh = 0._dp 
Call CouplingAhAhhhL(LambdaVari4,vvSM,cplAhAhhh)
...
cplAhAhAhAh = 0._dp 
Call CouplingAhAhAhAhL(LambdaVari4,cplAhAhAhAh)



cplAhAhhhhh = 0._dp 
Call CouplingAhAhhhhhL(LambdaVari4,cplAhAhhhhh)
...
cplhhhhhh = 0._dp 
Call CouplinghhhhhhL(LambdaVari4,vvSM,cplhhhhhh)
...
cplhhhhhhhh = 0._dp 
Call CouplinghhhhhhhhL(LambdaVari4,cplhhhhhhhh)
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
Call CouplingcFdFucVWpL(gt1,gt2,g2,ZUL,ZDL,cplcFdFucVWpL(gt1,gt2),cplcFdFucVWpR(gt1,gt2))
...
Subroutine CouplingcFdFucHpL(gt1,gt2,Yu,Yd,ZUL,ZUR,ZDL,ZDR,resL,resR)
...
Subroutine CouplinghhHpcHpL(LambdaVari4,vvSM,res)
...
Subroutine CouplingAhAhHpcHpL(LambdaVari4,res)
...
Subroutine CouplinghhhhHpcHpL(LambdaVari4,res)
...
Subroutine CouplingHpHpcHpcHpL(LambdaVari4,res)
...
Subroutine CouplingAhAhhhL(LambdaVari4,vvSM,res)
...
Subroutine CouplingAhAhAhAhL(LambdaVari4,res)
...
Subroutine CouplingAhAhhhhhL(LambdaVari4,res)
...
Subroutine CouplinghhhhhhL(LambdaVari4,vvSM,res)
...
Subroutine CouplinghhhhhhhhL(LambdaVari4,res)
...
Subroutine CouplingcFdFucVWpL(gt1,gt2,g2,ZUL,ZDL,resL,resR)
...
Subroutine CouplingsForVectorBosons(g2,g1,TW,vvSM,ZUL,ZDL,ZEL,cplAhcHpVWp,            & 
...
Complex(dp), Intent(in) :: ZUL(3,3),ZDL(3,3),ZEL(3,3)
...
Subroutine CouplingsForSMfermions(Ye,ZEL,ZER,g1,g2,TW,Yu,ZUL,ZUR,Yd,ZDL,              & 
& ZDR,g3,cplcUFeFeAhL,cplcUFeFeAhR,cplcUFeFehhL,cplcUFeFehhR,cplcUFeFeVPL,               & 
& cplcUFeFeVPR,cplcUFeFeVZL,cplcUFeFeVZR,cplcUFeFvcHpL,cplcUFeFvcHpR,cplcUFeFvcVWpL,     & 
& cplcUFeFvcVWpR,cplcUFuFuAhL,cplcUFuFuAhR,cplcUFuFdHpL,cplcUFuFdHpR,cplcUFuFdVWpL,      & 
& cplcUFuFdVWpR,cplcUFuFuhhL,cplcUFuFuhhR,cplcUFuFuVGL,cplcUFuFuVGR,cplcUFuFuVPL,        & 
& cplcUFuFuVPR,cplcUFuFuVZL,cplcUFuFuVZR,cplcUFdFdAhL,cplcUFdFdAhR,cplcUFdFdhhL,         & 
& cplcUFdFdhhR,cplcUFdFdVGL,cplcUFdFdVGR,cplcUFdFdVPL,cplcUFdFdVPR,cplcUFdFdVZL,         & 
& cplcUFdFdVZR,cplcUFdFucHpL,cplcUFdFucHpR,cplcUFdFucVWpL,cplcUFdFucVWpR)

Implicit None 
Real(dp), Intent(in) :: g1,g2,TW,g3
...
Subroutine CouplingsForTadpoles(Ye,ZEL,ZER,Yu,ZUL,ZUR,Yd,ZDL,ZDR,LambdaVari4,         & 
& vvSM,g2,g1,TW,cplcUFeFehhL,cplcUFeFehhR,cplcUFuFuhhL,cplcUFuFuhhR,cplcUFdFdhhL,        & 
& cplcUFdFdhhR,cplhhHpcHp,cplhhcHpVWp,cplhhhhHpcHp,cplAhAhhh,cplAhhhVZ,cplAhAhhhhh,      & 
...
Implicit None 
Real(dp), Intent(in) :: LambdaVari4,vvSM,g2,g1,TW

Complex(dp), Intent(in) :: Ye(3,3),ZEL(3,3),ZER(3,3),Yu(3,3),ZUL(3,3),ZUR(3,3),Yd(3,3),ZDL(3,3),ZDR(3,3)

Complex(dp), Intent(out) :: cplcUFeFehhL(3,3),cplcUFeFehhR(3,3),cplcUFuFuhhL(3,3),cplcUFuFuhhR(3,3),              & 
& cplcUFdFdhhL(3,3),cplcUFdFdhhR(3,3),cplhhHpcHp,cplhhcHpVWp,cplhhhhHpcHp,               & 
...
Subroutine CouplingsColourStructures(LambdaVari4,vvSM,cplAhAhhh,cplhhhhhh,            & 
& cplhhHpcHp,cplAhAhAhAh,cplAhAhhhhh,cplAhAhHpcHp,cplhhhhhhhh,cplhhhhHpcHp,              & 
& cplHpHpcHpcHp)
...
cplAhAhhh = 0._dp 
Call CouplingAhAhhhCS(LambdaVari4,vvSM,cplAhAhhh)



cplhhhhhh = 0._dp 
Call CouplinghhhhhhCS(LambdaVari4,vvSM,cplhhhhhh)



cplhhHpcHp = 0._dp 
Call CouplinghhHpcHpCS(LambdaVari4,vvSM,cplhhHpcHp)



cplAhAhAhAh = 0._dp 
Call CouplingAhAhAhAhCS(LambdaVari4,cplAhAhAhAh)



cplAhAhhhhh = 0._dp 
Call CouplingAhAhhhhhCS(LambdaVari4,cplAhAhhhhh)



cplAhAhHpcHp = 0._dp 
Call CouplingAhAhHpcHpCS(LambdaVari4,cplAhAhHpcHp)



cplhhhhhhhh = 0._dp 
Call CouplinghhhhhhhhCS(LambdaVari4,cplhhhhhhhh)



cplhhhhHpcHp = 0._dp 
Call CouplinghhhhHpcHpCS(LambdaVari4,cplhhhhHpcHp)



cplHpHpcHpcHp = 0._dp 
Call CouplingHpHpcHpcHpCS(LambdaVari4,cplHpHpcHpcHp)
...
Subroutine CouplingAhAhhhCS(LambdaVari4,vvSM,res1)
...
Subroutine CouplinghhhhhhCS(LambdaVari4,vvSM,res1)
...
Subroutine CouplinghhHpcHpCS(LambdaVari4,vvSM,res1)
...
Subroutine CouplingAhAhAhAhCS(LambdaVari4,res1)
...
Subroutine CouplingAhAhhhhhCS(LambdaVari4,res1)
...
Subroutine CouplingAhAhHpcHpCS(LambdaVari4,res1)
...
Subroutine CouplinghhhhhhhhCS(LambdaVari4,res1)
...
Subroutine CouplinghhhhHpcHpCS(LambdaVari4,res1)
...
Subroutine CouplingHpHpcHpcHpCS(LambdaVari4,res1)
