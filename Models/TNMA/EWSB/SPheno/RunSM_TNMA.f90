...
Contains 
 ...
 Subroutine RunSM_and_SUSY_RGEs(Qout,g1input,g2input,g3input,LambdaVari4input,         & 
& Yuinput,Ydinput,Yeinput,mu2input,vvSMinput,g1,g2,g3,LambdaVari4,Yu,Yd,Ye,              & 
& mu2,vvSM,CKMout,sinW2_out,Alpha_out,AlphaS_out,realCKM)
...
Real(dp) :: scale_save, Qin, tz, dt, g1D(61), g62_SM(62) 
 
 
! Run SUSY RGEs from M_SUSY to Qin 
Qin=sqrt(getRenormalizationScale()) 
scale_save = Qin 
Call ParametersToG61(g1input,g2input,g3input,LambdaVari4input,Yuinput,Ydinput,        & 
& Yeinput,mu2input,vvSMinput,g1D)

Call GToParameters61(g1D,g1,g2,g3,LambdaVari4,Yu,Yd,Ye,mu2,vvSM)
