...
Complex(dp),Intent(inout) :: Yuinput(3,3),Ydinput(3,3),Yeinput(3,3),m2SMinput
...
& m2SM,vvSM,CKM_160,sinW2_160,Alpha_160,AlphaS_160,.false.)
...
& Ydinput,Yeinput,m2SMinput,vvSMinput,g1,g2,g3,LambdaVari4,Yu,Yd,Ye,m2SM,vvSM,           & 
