...
! ------------------------------------------------------------------------------  
! File created at 0:16 on 24.8.2025   
! ----------------------------------------------------------------------  
 
 
Module Boundaries_NM 
 
Use Control 
Use Settings 
Use LoopCouplings_NM 
Use LoopMasses_NM 
Use LoopFunctions 
Use Mathematics 
Use Model_Data_NM 
...
Call ParametersToG60(g1,g2,g3,Lam,Yu,Yd,Ye,m2SM,gMZ)
...
mGUT = 1._dp 
Call GToParameters60(gB,g1,g2,g3,Lam,Yu,Yd,Ye,m2SM)
...
Implicit None 
Real(dp),Intent(out) :: g1,g2,g3,Lam
