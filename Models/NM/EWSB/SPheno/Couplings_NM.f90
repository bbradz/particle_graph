...
! ------------------------------------------------------------------------------  
! File created at 0:15 on 24.8.2025   
! ----------------------------------------------------------------------  
...
Implicit None 
Real(dp), Intent(in) :: Lam,vvSM,g1,g2,TW,g3
...
& ZDR,g3,vvSM,Lam,cplcUFeFeAhL,cplcUFeFeAhR,cplcUFeFehhL,cplcUFeFehhR,cplcUFeFeVPL,      & 
...
& cplcUFdFdVZR,cplcUFdFucHpL,cplcUFdFucHpR,cplcUFdFucVWpL,cplcUFdFucVWpR,cplcUFvFeHpL,   & 
...
Implicit None 
Real(dp), Intent(in) :: g1,g2,TW,g3,vvSM,Lam
...
Subroutine CouplingsForTadpoles(Ye,ZEL,ZER,Yu,ZUL,ZUR,Yd,ZDL,ZDR,Lam,vvSM,            & 
& g2,g1,TW,cplcUFeFehhL,cplcUFeFehhR,cplcUFuFuhhL,cplcUFuFuhhR,cplcUFdFdhhL,             & 
...
Implicit None 
Real(dp), Intent(in) :: Lam,vvSM,g2,g1,TW
